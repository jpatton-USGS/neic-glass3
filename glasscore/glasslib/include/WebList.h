...
class CWebList {
 public:
	...
	/**
	 * \brief Updates a site in the webs
	 * This function add/removes/updates the given site to all appropriate webs
	 * in the list of webs
	 *
	 * \param site - A shared_ptr to a CSite object containing the site to update
	 */
